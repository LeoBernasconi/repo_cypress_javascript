...
describe('Login tests', () => {
    ...
    it('Login OK', () =>{
        ...
        login_page.username_input().type(credentials.standar_user);
        login_page.password_input().clear();
        login_page.password_input().type(credentials.password);
    ...
    it('Login sending an incorrect password', () =>{
        ...
        login_page.username_input().type(credentials.standar_user);
        login_page.password_input().clear();
        login_page.password_input().type("wrong_password");
        login_page.login_button().click();
        login_page.error_message().should('be.visible');
        cy.contains("Epic sadface: Username and password do not match any user in this service").should('be.visible');
    })
    ...
    it('Login with a locked user', () =>{
        login_page.username_input().clear();
        login_page.username_input().type(credentials.locked_user);
        login_page.password_input().clear();
        login_page.password_input().type(credentials.password);
        login_page.login_button().click();
